      ...
      <div class="slider__comments">
        ...
        <div class="comments__item comments__item_add">
          ...
          <div class="comments__item-info">
            <div class="user__name">Антон Черепов</div>
            <form class="comments__form">
              <textarea name="" placeholder="Добавить комментарий" class="input_rounded comments__textarea"></textarea>
        ...
        <div class="comments__item">
          ...
          <div class="comments__item-info">
            ...
            <div class="comments__item-text">Эти чудесные весенние утра, которыми я наслаждаюсь от всего сердца. Я совсем один и блаженствую в здешнем краю, словно созданном для таких, как я. Я так счастлив, мой друг, так упоен ощущением.</div>
          </div>
        </div>
      </div>
    </div>
